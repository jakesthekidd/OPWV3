...
function Frame427322245() {
  return (
    <div className="absolute backdrop-blur-[0.5px] backdrop-filter bg-[rgba(0,0,0,0.59)] bottom-0 box-border content-stretch flex gap-[10px] items-center left-0 px-[8px] py-[4px] right-0">
  ...
  return (
    <div className="aspect-[79/111] relative rounded-[4px] shrink-0 w-full">
      <div className="aspect-[79/111] overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute aspect-[79/111] bottom-0 left-1/2 pointer-events-none rounded-[1.817px] top-0 translate-x-[-50%]" data-name="Screenshot 2023-08-28 at 2.23 2">
          ...
          <div aria-hidden="true" className="absolute border-[#72cdf4] border-[3px] border-solid inset-[-3px] rounded-[4.817px]" />
        </div>
        <Frame427322245 />
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#2474bb] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
  );
}
...
export default function Selected() {
  return (
    <div className="bg-[rgba(0,0,0,0.2)] relative rounded-[6px] size-full" data-name="Selected">
