import svgPaths from "./svg-ihyejnn69p";
...
export default function Unclassified() {
  return (
    <div className="bg-[#fbfcfc] relative rounded-[8px] size-full" data-name="Unclassified">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] isolate items-start justify-center p-[16px] relative size-full">
          <Frame427322048 />
          <div className="h-0 relative shrink-0 w-full z-[3]">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 516 1">
                <line id="Line 358" stroke="var(--stroke-0, #F3F5F7)" x2="516" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
