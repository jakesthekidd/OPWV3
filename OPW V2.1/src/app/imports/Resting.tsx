...
function Frame427322245() {
  return (
    <div className="absolute backdrop-blur-[0.5px] backdrop-filter bg-[rgba(0,0,0,0.39)] bottom-0 box-border content-stretch flex gap-[10px] items-center left-0 px-[8px] py-[4px] right-0">
...
export default function Resting() {
  return (
    <div className="relative rounded-[6px] size-full" data-name="Resting">
