...
function BaseInputComponent() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[4px] shrink-0 w-[222px]" data-name="Base Input Component">
      <div aria-hidden="true" className="absolute border-2 border-[#f1fafe] border-solid inset-[-2px] pointer-events-none rounded-[6px]" />
      <Input />
    </div>
  );
}
